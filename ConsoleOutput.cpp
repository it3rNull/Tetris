...
void CConsoleOutput::Printblock(short x, short y, std::string strContext, DWORD dwLen, int type)
{
	dwLen = std::min<DWORD>(dwLen, strContext.length());
	...
	SetConsoleCursorPosition(m_hBackBuffer, CursorPosition);
	if (type%10 == 0) {
	SetConsoleTextAttribute(m_hBackBuffer, 1);
	}
	else if (type % 10 == 1) {
	SetConsoleTextAttribute(m_hBackBuffer, 2);
	}
	else if (type % 10 == 2) {
		SetConsoleTextAttribute(m_hBackBuffer, 3);
	}
	else if (type % 10 == 3) {
		SetConsoleTextAttribute(m_hBackBuffer, 4);
	}
	else if (type % 10 == 4) {
		SetConsoleTextAttribute(m_hBackBuffer, 5);
	}
	else if (type % 10 == 5) {
		SetConsoleTextAttribute(m_hBackBuffer, 6);
	}
	else if (type % 10 == 6) {
		SetConsoleTextAttribute(m_hBackBuffer, 12);
	}
	else if (type == 8) {
		SetConsoleTextAttribute(m_hBackBuffer, 8);
	}
	WriteFile(m_hBackBuffer, strContext.c_str(), dwLen, &dw, NULL);
	SetConsoleTextAttribute(m_hBackBuffer, 7);
